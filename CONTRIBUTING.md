...
list](https://github.com/mainflux/sdk-js/issues) to determine if it already contains the
...
cd sdk-js
git remote add upstream https://github.com/mainflux/sdk-js.git
```
...
Create a new topic branch from `main` using the naming convention `JSSDK-[issue-number]`
to help us keep track of your contribution scope:

```
git checkout -b JSSDK-[issue-number]
```
...
```
git push origin JSSDK-[issue-number]
```
