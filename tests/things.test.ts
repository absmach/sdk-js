...
import type {
  Thing, ThingsPage, UsersPage, User,
} from "../src/sdk";
...
describe("Things", () => {
  ...
  test("ThingsByChannel should return a list of channels connected to a specific thing and return success", async () => {
    ...
    const response = await sdk.things.ThingsByChannel(
      channelId,
      queryParams,
      domainId,
      token,
  ...
  test("ThingsPermissions should update a thing secret and return success", async () => {
    ...
    const response = await sdk.things.ThingsPermissions(
      thingId,
      domainId,
      token,
    );
  ...
  test("ListThingUsers should list users linked to a thing and return success", async () => {
    ...
    const response = await sdk.things.ListThingUsers(
      thingId,
      queryParams,
      domainId,
      token,
  ...
  test("ShareThing should share a thing and return success", async () => {
    ...
    const response = await sdk.things.ShareThing(
      thingId,
      relation,
      userIds,
      domainId,
  ...
  test("UnShareThing should unshare a thing and return success", async () => {
    ...
    const response = await sdk.things.UnShareThing(
      thingId,
      relation,
      userIds,
      domainId,
