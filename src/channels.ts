...
//    *
//    */
//   private readonly channels_url: URL
...
//   public async Create (channel: Channel, token: string): Promise<Channel> {
...
//   public async Enable (channel_id: string, token: string): Promise<ChannelsInterface> {
//     // Disables channel with specified id.
//     /**
