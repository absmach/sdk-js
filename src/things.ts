...
export default class Things {
  ...
  //       method: 'post',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}/bulk`, this.thingsUrl),
  //       headers: {
  ...
  //       method: 'get',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}/${thing_id}`, this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       }
  ...
  //       method: 'get',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}/${thing_id}/channels?${new URLSearchParams(query_params).toString()}`, this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       }
  ...
  //       method: 'get',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}?${new URLSearchParams(query_params).toString()}`, this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       }
  ...
  //       method: 'post',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}/${thing_id}/disable`, this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       }
  ...
  //       method: 'patch',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}/${thing_id}/secret`, this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       },
  ...
  //       method: 'patch',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}/${thing_id}/tags`, this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       },
  ...
  //       method: 'patch',
  //       maxBodyLength: 2000,
  //       url: new URL(`${this.thingsEndpoint}/${thing_id}/owner`, this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       },
  ...
  //     const payload = { subject: thing_id, object: channel_id, actions }
  //     const options = {
  //       method: 'post',
  //       maxBodyLength: 2000,
  ...
  //     const payload = { subjects: thing_ids, objects: channel_ids, actions }
  //     const options = {
  //       method: 'post',
  //       maxBodyLength: 2000,
  //       url: new URL('connect', this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       },
  ...
  //       method: 'post',
  //       maxBodyLength: 2000,
  //       url: new URL('disconnect', this.thingsUrl),
  //       headers: {
  //         'Content-Type': this.content_type,
  //         Authorization: `Bearer ${token}`
  //       },
  ...
  //       method: 'post',
  //       maxBodyLength: 2000,
  //       url: new URL('identify', this.thingsUrl.toString()),
  //       headers: {
  //         'Content-Type': this.content_type,
...
//       method: 'post',
//       maxBodyLength: 2000,
//       url: new URL(this.thingsUrl + 'channels/object/access'),
//       headers: {
//         'Content-Type': this.content_type,
//         Authorization: `Bearer ${token}`
//       },
