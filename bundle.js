...
},{"./mainflux/sdk":7}],2:[function(require,module,exports){
...
class Certs {
  ...
  Revoke(thing_id, token) {
    ...
    return axios.request(options).then(_response => {
      return "DELETED";
    }).catch(error => {
      return error.response.data;
    });
...
},{"axios":10}],5:[function(require,module,exports){
"use strict";
...
},{"./bootstrap":2,"./certs":3,"./channels":4,"./groups":5,"./messages":6,"./things":8,"./users":9}],8:[function(require,module,exports){
"use strict";
...
class Users {
  ...
  GetAll(query_params, token) {
    ...
    const options = {
      method: "get",
      maxBodyLength: Infinity,
      url: `${this.users_url}/${this.usersEndpoint}?${new URLSearchParams(
        query_params,
      ).toString()}`,
      headers: {
        "Content-Type": this.content_type,
...
},{"../core/AxiosError.js":18,"../utils.js":52,"./http.js":39,"./xhr.js":12}],12:[function(require,module,exports){
'use strict';
...
},{"../cancel/CanceledError.js":15,"../core/AxiosError.js":18,"../core/AxiosHeaders.js":19,"../core/buildFullPath.js":21,"../defaults/transitional.js":27,"../helpers/parseProtocol.js":41,"../helpers/speedometer.js":42,"../platform/index.js":51,"./../core/settle.js":24,"./../helpers/buildURL.js":32,"./../helpers/cookies.js":34,"./../helpers/isURLSameOrigin.js":38,"./../utils.js":52}],13:[function(require,module,exports){
'use strict';
...
},{"./adapters/adapters.js":11,"./cancel/CancelToken.js":14,"./cancel/CanceledError.js":15,"./cancel/isCancel.js":16,"./core/Axios.js":17,"./core/AxiosError.js":18,"./core/AxiosHeaders.js":19,"./core/mergeConfig.js":23,"./defaults/index.js":26,"./env/data.js":28,"./helpers/HttpStatusCode.js":30,"./helpers/bind.js":31,"./helpers/formDataToJSON.js":35,"./helpers/isAxiosError.js":37,"./helpers/spread.js":43,"./helpers/toFormData.js":44,"./utils.js":52}],14:[function(require,module,exports){
'use strict';
...
},{"../helpers/buildURL.js":32,"../helpers/validator.js":46,"./../utils.js":52,"./AxiosHeaders.js":19,"./InterceptorManager.js":20,"./buildFullPath.js":21,"./dispatchRequest.js":22,"./mergeConfig.js":23}],18:[function(require,module,exports){
'use strict';
...
},{"../helpers/parseHeaders.js":40,"../utils.js":52}],20:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError.js":18,"../helpers/formDataToJSON.js":35,"../helpers/toFormData.js":44,"../helpers/toURLEncodedForm.js":45,"../platform/index.js":51,"../utils.js":52,"./transitional.js":27}],27:[function(require,module,exports){
'use strict';
...
},{"../helpers/AxiosURLSearchParams.js":29,"../utils.js":52}],33:[function(require,module,exports){
'use strict';
...
},{"../platform/index.js":51,"./../utils.js":52}],35:[function(require,module,exports){
'use strict';
...
},{"./../utils.js":52}],38:[function(require,module,exports){
'use strict';
...
},{"../platform/index.js":51,"./../utils.js":52}],39:[function(require,module,exports){
"use strict";
...
},{"./../utils.js":52}],41:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError.js":18,"../platform/node/classes/FormData.js":39,"../utils.js":52,"buffer":54}],45:[function(require,module,exports){
'use strict';
...
},{"../platform/index.js":51,"../utils.js":52,"./toFormData.js":44}],46:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind.js":31}],53:[function(require,module,exports){
'use strict'
...
},{"base64-js":53,"buffer":54,"ieee754":55}],55:[function(require,module,exports){
